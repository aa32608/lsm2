...
const MyListingCard = React.memo(({
  ...
  return (
    <article className="my-listing-card" role="listitem">
        ...
        <div className="my-listing-header-top">
          ...
          <div className="my-listing-header-content">
            ...
            <div className="my-listing-meta-row">
              ...
              {l.createdAt && (
                <span className="my-listing-pill my-listing-pill-soft" aria-label={`Posted: ${new Date(l.createdAt).toLocaleDateString()}`}>
                  <span aria-hidden="true">📅</span>
      ...
      <div className="my-listing-body">
        ...
        {(l.tags || l.contact) && (
          <div className="my-listing-highlights">
            {l.tags && (
              <span className="my-listing-pill my-listing-pill-tag" aria-label={`Tag: ${l.tags.split(",")[0]?.trim() || l.tags}`}>
                <span aria-hidden="true">🏷️</span>
                {l.tags.split(",")[0]?.trim() || l.tags}
              </span>
            )}
            {l.contact && (
              <span className="my-listing-pill my-listing-pill-contact" aria-label={`Contact: ${l.contact}`}>
                <span aria-hidden="true">📞</span>
                {l.contact}
              </span>
            )}
