...
export const TRANSLATIONS = {
  en: {
    ...
    featuredCtaDesc: "Choose 12 months to feature your listing: it appears first in results, gets a highlighted badge, and up to 3x more views from local customers.",
    featuredCtaCta: "Choose 12 months for maximum visibility",
    ...
    terms3List1: "All payments are processed securely through Dodo Payments platform",
    terms3List2: "Payment information is handled according to Dodo Payments' security standards and PCI compliance",
    terms3List3: "Refunds and cancellations are subject to Dodo Payments' terms and our listing policies",
    ...
    terms3List6: "For payment disputes, please contact our support team or refer to Dodo Payments' dispute resolution process",
    ...
    terms3TextNew: "BizCall MK uses Dodo Payments as our secure payment processing partner. By making a payment, you agree to:",
    ...
    privacy1List3: "Payment information processed securely through Dodo Payments",
    ...
    privacy2List2: "Process payments securely through Dodo Payments",
    ...
    privacy3List1: "Dodo Payments: We share payment information with Dodo Payments to process transactions securely. Dodo Payments handles all payment data according to PCI DSS standards.",
    ...
    privacy4List2: "Secure payment processing through Dodo Payments (PCI compliant)",
  ...
  sq: {
    ...
    featuredCtaDesc: "Zgjidhni 12 muaj për ta veçuar listimin: shfaqet i pari në rezultatet, merr një badge të theksuar dhe deri në 3x më shumë shikime nga klientët lokalë.",
    featuredCtaCta: "Zgjidhni 12 muaj për dukshmëri maksimale",
    ...
    terms3List1: "Të gjitha pagesat përpunohen në mënyrë të sigurt përmes platformës Dodo Payments",
    terms3List2: "Informacionet e pagesës trajtohen sipas standardeve të sigurisë së Dodo Payments dhe përputhjes PCI",
    terms3List3: "Rimbursimet dhe anulimet i nënshtrohen kushteve të Dodo Payments dhe politikave tona të listimit",
    ...
    terms3List6: "Për mosmarrëveshjet e pagesës, ju lutemi kontaktoni ekipin tonë të mbështetjes ose referojuni procesit të zgjidhjes së mosmarrëveshjeve të Dodo Payments",
    ...
    terms3TextNew: "BizCall MK përdor Dodo Payments si partnerin tonë të sigurt për përpunimin e pagesave. Duke bërë një pagesë, ju pranoni:",
    ...
    privacy1List3: "Informacione pagese të përpunuara në mënyrë të sigurt përmes Dodo Payments",
    ...
    privacy2List2: "Përpunojmë pagesat në mënyrë të sigurt përmes Dodo Payments",
    ...
    privacy3List1: "Dodo Payments: Ne ndajmë informacione pagese me Dodo Payments për të përpunuar transaksionet në mënyrë të sigurt. Dodo Payments trajton të gjitha të dhënat e pagesës sipas standardeve PCI DSS.",
    ...
    privacy4List2: "Përpunim të sigurt pagesash përmes Dodo Payments (i përputhshëm me PCI)",
  ...
  mk: {
    ...
    featuredCtaDesc: "Изберете 12 месеци за да го истакнете огласот: се појавува прв во резултатите, добива истакната ознака и до 3x повеќе прегледи од локалните клиенти.",
    featuredCtaCta: "Изберете 12 месеци за максимална видливост",
    ...
    privacy1List3: "Информации за плаќање обработени безбедно преку Dodo Payments",
    ...
    privacy2List2: "Обработиме плаќања безбедно преку Dodo Payments",
    ...
    privacy3List1: "Dodo Payments: Споделуваме информации за плаќање со Dodo Payments за безбедна обработка на трансакции. Dodo Payments ги ракува сите податоци за плаќање согласно стандардите PCI DSS.",
    ...
    privacy4List2: "Безбедна обработка на плаќања преку Dodo Payments (усогласено со PCI)",
