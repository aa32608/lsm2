...
export const TRANSLATIONS = {
  en: {
    ...
    pricingPaymentMethodsText: "Listing fees are one-time charges in EUR for the selected duration. Payments are processed securely by our third-party payment processors (such as Stripe or Lemon Squeezy). There are currently no automatic renewals or recurring subscriptions.",
    ...
    terms3List1: "All payments are processed securely through our third-party payment processors (such as Stripe or Lemon Squeezy).",
    terms3List2: "Payment information is handled according to industry security standards (for example, PCI-DSS compliance) by these providers.",
    ...
    privacy1List3: "Payment information processed securely through our payment processors (for example, Stripe or Lemon Squeezy)",
    ...
    privacy2List2: "Process payments securely through third-party payment processors (such as Stripe or Lemon Squeezy)",
    ...
    privacy3List1: "Payment processors (e.g. Stripe, Lemon Squeezy): We share payment information with our payment providers to process transactions securely. Payment data is handled according to PCI DSS standards.",
    ...
    privacy4List2: "Secure payment processing through PCI-compliant payment processors (such as Stripe or Lemon Squeezy)",
  ...
  sq: {
    ...
    pricingPaymentMethodsText: "Tarifat e listimit janë pagesa njëherëshe në EUR për kohëzgjatjen e zgjedhur. Pagesat përpunohen në mënyrë të sigurt nga përpunuesit tanë të palëve të treta (si p.sh. Stripe ose Lemon Squeezy). Aktualisht nuk ka rinovime automatike apo abonime mujore.",
    ...
    terms3List1: "Të gjitha pagesat përpunohen në mënyrë të sigurt përmes përpunuesve tanë të palëve të treta (si Stripe ose Lemon Squeezy).",
    ...
    privacy1List3: "Informacione pagese të përpunuara në mënyrë të sigurt përmes përpunuesve tanë të pagesave (p.sh. Stripe, Lemon Squeezy)",
    ...
    privacy2List2: "Përpunojmë pagesat në mënyrë të sigurt përmes përpunuesve të palëve të treta (si Stripe ose Lemon Squeezy)",
    ...
    privacy3List1: "Përpunuesit e pagesave (p.sh. Stripe, Lemon Squeezy): Ne ndajmë informacione pagese me ofruesit tanë për të përpunuar transaksionet në mënyrë të sigurt. Të dhënat e pagesës trajtohen sipas standardeve PCI DSS.",
  ...
  mk: {
    ...
    terms3List1: "Сите плаќања се обработуваат безбедно преку наши даватели на плаќања од трета страна (како Stripe или Lemon Squeezy).",
    ...
    pricingPaymentMethodsText: "Надоместоците за огласување се еднократни уплати во EUR за избраниот период. Плаќањата се обработуваат безбедно преку наши даватели на плаќања од трета страна (како Stripe или Lemon Squeezy). Во моментов нема автоматски обновувања или претплати.",
    ...
    terms2List2New: "Почитување на правата за интелектуална сопственост",
    terms2List3New: "Не се вклучувајте во спам или вознемирување",
    terms3TextNew: "BizCall MK користи безбеден давател на плаќања од трета страна (на пр. Stripe или Lemon Squeezy). Со правење плаќање, се согласувате:",
    terms4TextNew: "BizCall MK прикажува реклами преку Google Ads. Со користење на нашиот сервис, признавате:",
    terms5TextNew: "BizCall MK е оптимизиран за пребарувачи и користи Google Search Console за управување со веб-страницата:",
    ...
    privacy1List3: "Информации за плаќање обработени безбедно преку наши даватели на плаќања (на пр. Stripe, Lemon Squeezy)",
    ...
    privacy2List2: "Обработуваме плаќања безбедно преку даватели на плаќања од трета страна (како Stripe или Lemon Squeezy)",
    ...
    privacy3List1: "Даватели на плаќања (на пр. Stripe, Lemon Squeezy): Споделуваме информации за плаќање со нашите даватели за безбедна обработка на трансакции. Податоците за плаќање се обработуваат согласно стандардите PCI DSS.",
